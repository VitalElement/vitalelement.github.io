<!DOCTYPE html>
	...
	<title>VitalElement &lsaquo; Log In</title>
...
<meta name='robots' content='noindex,follow' />
	...
	<body class="login login-action-login wp-core-ui  locale-en-gb">
		<div id="login">
		<h1><a href="https://wordpress.org/" title="Powered by WordPress" tabindex="-1">VitalElement</a></h1>
...
<form name="loginform" id="loginform" action="/wp-login.php" method="post">
	...
	<p class="submit">
		...
		<input type="hidden" name="redirect_to" value="https://blog.vitalelement.co.uk/wp-admin/" />
...
if(typeof wpOnload=='function')wpOnload();
	...
	<p id="backtoblog"><a href="/">&larr; Back to VitalElement</a></p>
